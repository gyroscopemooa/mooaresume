// Verbatim copy of the schema from the 2026-08-20 `feature/original-annotations` branch
// (commits 26bb5df/68807e1), kept as its own file so the "Claude 복원판" mirror can render
// with full fidelity without touching the shared, actively-developed `@/domain/result-document`.
// See docs/agent-change-log.md for why this exists as a separate file.
import { z } from "zod";
