...
const samples: Record<CareerAiSampleScope, CareerAiSample> = {
  ...
  work_style: {
    scope: "work_style", reportTitle: "업무성향 분석 리포트", badge: "업무성향 30개 유형", code: "02", typeName: "차근차근 조율가", axesLabel: "업무 방식의 단서", headline: "의견을 모아 조율하고, 계획을 차근차근 실행하는 편", intro: "5가지 성향 응답 중 협업 지향과 계획·완수가 함께 두드러진 예시 유형입니다. 실제 리포트에서는 점수를 성격 판정이 아닌 업무 방식과 협업 환경을 점검하는 질문으로 바꿉니다.",
    axes: [{ label: "계획·완수", score: 79, description: "계획을 세우고 마무리 기준을 챙기는 경향" }, { label: "협업 지향", score: 72, description: "협업 과정에서 조율과 배려를 중시하는 경향" }, { label: "정서적 안정", score: 63, description: "변화와 압박 속에서도 차분히 정리하는 경향" }],
