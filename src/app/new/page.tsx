      ...
      <div className={"container " + styles.page}>
        ...
        <section id="faq" className={styles.block}>
          ...
          <div className={styles.faq}>
            ...
            <details>
              <summary>같은 글을 다시 첨삭하면 표현이 달라질 수 있나요?</summary>
              <p>같은 글도 적절한 표현이 여러 가지여서 첨삭·재첨삭 시 말투나 문장 구성이 조금 달라질 수 있습니다. 같은 자료와 설정에서는 무아레쥬메의 첨삭 기준과 핵심 개선 방향을 일관되게 적용합니다.</p>
            </details>
            <details>
