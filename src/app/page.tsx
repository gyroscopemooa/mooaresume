...
export default function Home() {
  ...
  return (
    <main>
      ...
      <footer className="container"><div className="brand"><span className="brand-mark">M</span><span>MOOA <b>Resume</b></span></div><p>지원자의 실제 경험을 존중하는 AI 취업 코치</p><Link href="/guide">이용방법 · 자주 묻는 질문</Link><span>© 2026 MOOA Resume</span></footer>
    </main>
  );
}
