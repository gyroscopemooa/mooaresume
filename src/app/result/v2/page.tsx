...
/**
 * The previous default result screen, moved here unchanged when `/result` was
 * promoted to the completed workspace. Kept reachable so the two can still be
 * compared and so the promotion can be undone by swapping the two files back.
 */
