 ...
 *
 * 4번 표는 **수탁자와 위탁업무만** 적습니다. 법이 요구하는 것이 그 둘이고,
 * "계정·지원 자료·분석 기록 저장, 로그인 처리"처럼 적으면 어떤 저장소에 무엇이
 * 들어가고 인증을 무엇으로 하는지까지 그려집니다. 그건 이용자가 알아야 할
 * 내용이 아니라 이 서비스의 설계도입니다.
 *
 * 다만 **작게 만들거나 아래로 숨기지는 않습니다.** 법은 이 내용을 "정보주체가
 * 언제든지 쉽게 확인할 수 있도록" 공개하라고 합니다. 읽기 어렵게 만드는 것은
 * 공개하지 않은 것에 가깝고, 그건 줄이는 것과 다른 이야기입니다.
 *
 * Google과 Microsoft는 7번(쿠키·자동 수집)으로 옮겼습니다. 광고 성과 측정과
 * 화면 흐름 분석은 우리가 맡긴 처리업무가 아니라 자동 수집 장치이고, 위탁으로
 * 묶어 적는 쪽이 오히려 부정확했습니다.
 */
      ...
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p className={styles.lead}>
            원활한 서비스 제공을 위해 개인정보 처리업무의 일부를 외부 전문업체에 위탁하고 있습니다.
            위탁 계약을 통해 개인정보가 안전하게 관리되도록 필요한 사항을 정하고 관리·감독합니다.
          </p>
          <table className={styles.table}>
            <tbody>
              <tr><th>Supabase</th><td>서비스 운영을 위한 데이터 보관</td></tr>
              <tr><th>OpenAI</th><td>AI 기반 자기소개서 분석</td></tr>
              <tr><th>Polar</th><td>결제 및 환불 처리</td></tr>
              <tr><th>Resend</th><td>서비스 관련 이메일 발송</td></tr>
              <tr><th>Cloudflare</th><td>서비스 제공 및 보안</td></tr>
            </tbody>
          </table>
          ...
          <p className={styles.note}>
            <b>국외 이전 안내.</b> 위 수탁자의 서버는 대한민국 밖(주로 미국)에 있습니다. 이전되는 항목과 목적은 위 표와 같고,
        ...
        <section className={styles.section}>
          <h2>7. 쿠키와 자동 수집 장치</h2>
          <p>
            로그인 상태를 유지하는 데 쿠키를 씁니다. 이 쿠키를 막으면 로그인이 되지 않습니다.
          </p>
          <p>
            그 밖에 광고 성과 측정(Google)과 화면 이용 흐름 분석(Microsoft Clarity)에 쿠키와 유사 기술이 쓰입니다.
            이쪽은 브라우저 설정에서 거부하셔도 서비스 이용에 지장이 없습니다.
          </p>
        </section>
