      ...
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            목적으로 미국에 소재한 Polar에 이전되며 관계 법령에 따른 기간 동안 보관합니다. 이메일 주소는 서비스
        ...
        <section className={styles.section}>
          ...
          <p>
            그 밖에 쿠키와 유사 기술로 행태정보를 수집합니다. 광고 성과 측정을 목적으로 광고 식별자와 방문·전환
            기록을 Google을 통해 수집하며, 브라우저의 쿠키 설정 또는 Google 광고 설정에서 맞춤 광고를 해제하시면
