 ...
 *
 * 4·5·8번은 **표가 아니라 문장으로** 씁니다. 업체마다 항목·목적·기간을 칸에
 * 나눠 담으면 법정 기재사항을 다 채우고도 결국 더 잘 정리된 스펙시트가 됩니다 —
 * 눈이 세로로 훑고, 무엇을 무엇으로 만들었는지가 한눈에 들어옵니다. 문장으로
 * 이으면 같은 내용을 빠짐없이 적으면서도 훑어 읽히지 않습니다.
 *
    ...
    <main className={styles.page}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          ...
          <table className={styles.table}>
            <tbody>
              ...
              <tr>
                <th>결제</th>
                <td>주문 번호, 상품, 금액, 결제 상태. <b>카드번호와 계좌번호는 저희 서버를 지나가지 않습니다</b> — 웹에서의 결제는 Polar에서, Google Play에서 설치한 앱에서의 결제는 Google Play에서 이루어지고 저희는 그 결과만 받습니다.</td>
              </tr>
              <tr>
                <th>추천·이용권</th>
        ...
        <section className={styles.section}>
          ...
          <p>
            원활한 서비스 제공을 위해 서비스 운영을 위한 데이터 보관, AI 기반 콘텐츠 분석, 결제 및 환불 처리,
            서비스 관련 이메일 발송, 서비스 제공 및 보안에 관한 업무를 외부 전문업체에 위탁하고 있으며,
            위탁 계약을 통해 개인정보의 기술적·관리적 보호조치, 재위탁 제한, 위탁업무 목적 외 처리 금지,
            수탁자에 대한 관리·감독 및 손해배상 등 책임에 관한 사항을 정하고 있습니다. 수탁자가 모두 국외
            사업자이므로 수탁자의 명칭을 포함한 구체적인 사항은 아래 5. 개인정보의 국외 이전에 법정 기재사항과
            함께 적었습니다.
          </p>
        </section>
        ...
        <section className={styles.section}>
          <h2>5. 개인정보의 국외 이전</h2>
          <p>
            계약의 이행과 이용자 편의 증진을 위해 아래와 같이 개인정보의 처리위탁·보관을 국외에서 수행하고 있으며,
            이전은 서비스 이용 과정에서 정보통신망을 통해 수시로 이루어집니다.
          </p>
          <p>
            이용자의 계정 식별정보와 입력하신 문서 및 이용 기록은 서비스 운영을 위한 데이터 보관을 목적으로 미국에
            소재한 Supabase에 이전되며 회원 탈퇴 시까지 보관합니다(3번의 법령상 보관 항목은 제외합니다).
            입력하신 문서는 AI 기반 콘텐츠 분석을 목적으로 미국에 소재한 OpenAI에 이전되며 요청 처리 후
            삭제됩니다(공급자 정책에 따라 최대 30일). 주문 번호와 상품·금액·결제 상태는 결제 및 환불 처리를
            목적으로 미국에 소재한 Polar에 이전되며 관계 법령에 따른 기간 동안 보관합니다. Google Play에서 설치한 앱에서 결제하시면 구매를 확인하고 승인하기 위해 구매 토큰과 상품 번호를 미국에 소재한 Google에 전달하며, 보관 기간은 Google의 정책과 관계 법령에 따릅니다. 이메일 주소는 서비스
            관련 이메일 발송을 목적으로 미국에 소재한 Resend에 이전되며 발송 목적을 달성한 때까지 보관합니다.
            접속 기록(IP 주소 등)은 서비스 제공 및 보안을 목적으로 미국에 소재한 Cloudflare에 이전되며 3개월간
            보관합니다.
          </p>
          <p>
            이용자는 개인정보의 국외 이전을 거부하실 수 있습니다. 다만 자료의 저장과 분석 자체가 위 설비 위에서
            이루어지므로 거부하시는 경우 서비스 이용이 제한됩니다. 각 이전받는 자의 연락처는 11번의 개인정보
            보호책임자에게 문의하시면 안내해 드리며, 분석을 위해 전달된 내용은 AI 공급자의 모델 학습에 사용되지
            않습니다.
          </p>
        </section>
        ...
        <section className={styles.section}>
          ...
          <p>
            그 밖에 쿠키와 유사 기술로 행태정보를 수집합니다. 광고 성과 측정과 방문 통계를 목적으로 광고 식별자와 방문·전환
            기록을 Google(Google Ads, Google 애널리틱스)을 통해 수집하며, 브라우저의 쿠키 설정 또는 Google 광고 설정에서 맞춤 광고를 해제하시면
            거부하실 수 있습니다. 이용 흐름 분석과 오류 확인을 목적으로 화면에서의 이동 경로와 클릭·스크롤 기록,
            브라우저 종류를 Microsoft Clarity를 통해 수집하며, 브라우저의 쿠키 설정에서 거부하실 수 있습니다.
            이들 행태정보는 거부하셔도 서비스 이용에 지장이 없고, 광고와 분석 목적으로만 쓰며, 회원님이 입력하신
            자기소개서·이력서 등 지원 자료는 이 도구들에 전달되지 않습니다.
          </p>
        </section>
