  ...
  return <div className={styles.guide} id="career-description-guide">
    ...
    <section className={styles.section}>
      ...
      <div className={styles.faq}>
        <div className={styles.faqItem}><b>경력기술서와 직무기술서, 같은 건가요?</b><p>이 도구가 만드는 것은 지원자가 자신의 경력을 회사별·기간별로 정리해 제출하는 문서입니다. 현장에서는 &quot;경력기술서&quot;, &quot;직무기술서&quot;, &quot;경력 요약서&quot;처럼 회사마다 다르게 부르지만 요구하는 내용은 대체로 같습니다.</p></div>
    ...
    <section className={styles.seoLead}>
      <p><b>경력기술서 양식, 직무기술서 작성법을 찾는 이유는 대개 하나입니다.</b> 여러 회사, 여러 서류에 흩어진 경력을 한 장으로 어떻게 정리해야 할지 막막해서입니다. 경력증명서를 회사에 요청하고, 예전 이력서를 열어 보고, 자격증 사진을 뒤지는 그 과정 자체가 시간이 오래 걸립니다.</p>
