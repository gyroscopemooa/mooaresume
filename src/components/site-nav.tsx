...
const SECTIONS = [
  ...
  {
    // 드로어(왼쪽 가장자리 마크)는 760px 아래에서 접힙니다. 휴대폰에서 이
    // 목록으로 가는 길은 여기뿐이므로, 바로 갈 수 있는 이력서를 함께 둡니다.
    title: "입사지원 서류",
    links: [
      { href: "/resume", label: "이력서 만들기", hint: "무료 · 로그인 없이 바로" },
      { href: "/analyze", label: "자기소개서 첨삭", hint: "공고와 지원자료를 함께 읽고" },
    ],
  },
  {
    title: "커뮤니티",
