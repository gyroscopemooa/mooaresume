...
export function ResearchConsentGate() {
  ...
  return <section className={styles.gate}>
    ...
    {open && <div className={styles.detail}>
      <p>이름·연락처·주소를 지운 사본만 보관하고, 어떤 표현이 강점이 되고 무엇이 감점 위험인지 판단 기준을 다듬는 데 씁니다.</p>
      <p>회사명·직무·기간·성과 수치는 남깁니다. 이것까지 지우면 분석할 것이 없습니다.</p>
      <p><b>동의하지 않아도 결과와 기능은 완전히 같습니다.</b> 언제든 결과 화면 아래에서 철회하실 수 있고, 철회하시면 보관 중이던 사본도 그 자리에서 지웁니다.</p>
    </div>}
