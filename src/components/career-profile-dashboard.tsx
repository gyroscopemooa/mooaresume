...
const lightProfileCss = `
.${styles.shell}{background:#fdfdfb!important;color:#20211e!important}.${styles.sidebar}{background:#f8f8f5!important;border-color:#deded8!important}.${styles.brand}{color:#20211e!important}.${styles.sidebar}>p,.${styles.sidebar} small{color:#84857e!important}.${styles.sidebar} nav>*{color:#696b63!important}.${styles.sidebar} nav .${styles.active}{background:#e8eee9!important;color:#223b2c!important}.${styles.content}{background:#fdfdfb!important}.${styles.dashTop}{border-color:#deded8!important}.${styles.dashTop} p,.${styles.note},.${styles.apply} small{color:#717a73!important}.${styles.dashTop} h1,.${styles.chartGrid} h2{color:#20211e!important}.${styles.dashTop}>span{border-color:#cdd6cf!important;color:#58645d!important}.${styles.summary} article,.${styles.chartGrid} article,.${styles.apply}{border-color:#deded8!important;background:#fff!important}.${styles.summary} strong{color:#16724d!important}.${styles.summary} span,.${styles.chartGrid} small,.${styles.apply} p{color:#5c6961!important}.${styles.chartGrid} a{color:#16724d!important}.${styles.apply}{background:#eef4ef!important}.${styles.apply} h2{color:#203428!important}.${styles.apply} a,.${styles.empty} a{border-radius:5px!important;background:#18261d!important;color:#fff!important}
`;
...
export function CareerProfileDashboard() {
  ...
  if (auth === "loading") return <main className={styles.loading} style={{ fontFamily: "var(--font-sans), 'Noto Sans KR', system-ui, sans-serif" }}>내 커리어 프로필을 확인하고 있어요.</main>;
  if (auth === "guest") return <main className={styles.guest} style={{ fontFamily: "var(--font-sans), 'Noto Sans KR', system-ui, sans-serif" }}><LockKeyhole /><p>CAREER PROFILE</p><h1>내 결과를 계속 보려면<br />로그인해 주세요.</h1><span>검사는 로그인 없이 시작할 수 있어요. 로그인하면 이 기기에서 완료한 결과를 종합 프로필에 모아 볼 수 있습니다.</span><div><Link href="/career/login?next=/career/profile">로그인하기</Link><Link href="/career">검사 홈으로</Link></div></main>;
